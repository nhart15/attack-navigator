...
def main():
    ...
    parser.add_argument("--matrix", "-m", type=str, default="src\\assets\\engage_matrix.yaml", help="Path to engage_matrix.yaml")
    parser.add_argument("--output", "-o", type=str, default="src\\assets", help="Output directory")
